...
posts.forEach(function(post) {
    ...
    postInhoudDiv.innerHTML = post.Inhoud;
        ...
        // de div word een child dus je krijgt een parent met childrens
    ...
    postsDiv.appendChild(postDiv);
        ...
        // give class
    postOnderwerpDiv.className = "onderwerp-css";
    postSchrijverDiv.className = "schrijver-css";
    postInhoudDiv.className = "inhoud-css";
